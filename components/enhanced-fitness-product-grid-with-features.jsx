...
const products = [
  ...
  },
  {
    ...
    rating: 4.3,
    reviews: 95,
    image: "https://images.unsplash.com/photo-1600881333168-2ef49b341f30?w=300&h=300&fit=crop",
    discount: 14,
    category: "Equipment",
  },
  {
...
const mainProduct = {
  ...
  description: "Transform your home into a complete fitness center with our all-in-one package. Includes adjustable dumbbells, a versatile bench, resistance bands, and a year of online personal training.",
  rating: 4.9,
  reviews: 523,
  ...
  return (
    (<Card
      ...
      <div className="relative">
        ...
        {isHovered && (
          <div
            className="absolute inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center transition-opacity duration-200">
            <Button
              variant="secondary"
              size="sm"
      ...
      <CardContent className="p-4">
        <h3
          className="font-semibold text-lg mb-1 text-white hover:text-primary transition-colors duration-200">{product.name}</h3>
        ...
        <div className="flex items-center justify-between">
          <div>
            {product.discountedPrice ? (
              <>
                <span className="font-bold text-lg text-primary">${product.discountedPrice.toFixed(2)}</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
        ...
        <div>
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <span className="font-bold text-2xl text-primary">${product.discountedPrice.toFixed(2)}</span>
...
export function EnhancedFitnessProductGridWithFeatures() {
  ...
  return (
    (<div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-4xl font-bold mb-8 text-center text-primary">Fitness Gear & Supplements</h1>
        ...
        <div className="mb-8 p-6 bg-gray-800/50 rounded-lg backdrop-blur-sm">
          ...
          <div
            className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0 md:space-x-4">
            <div className="w-full md:w-1/2">
              <Label htmlFor="price-range" className="mb-2 block text-gray-300">Price Range: ${priceRange[0]} - ${priceRange[1]}</Label>
              <Slider
                id="price-range"
                min={0}
                max={300}
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="show-discounted" className="text-gray-300">Show only discounted items</Label>
            </div>
          </div>
        </div>
      ...
      <footer className="mt-16 border-t border-gray-800 pt-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-4">
          <div className="text-center md:text-left">
            <h3 className="text-xl font-semibold mb-4 text-primary">💪 Fitness Club</h3>
            <p className="text-gray-400 mb-4">Your one-stop shop for all your fitness needs. Quality gear, supplements, and tech to support your fitness journey.</p>
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-2">
              <li><a
                href="#"
                className="text-gray-400 hover:text-primary transition-colors duration-200">About Us</a></li>
              <li><a
                href="#"
                className="text-gray-400 hover:text-primary transition-colors duration-200">Contact</a></li>
              <li><a
                href="#"
                className="text-gray-400 hover:text-primary transition-colors duration-200">FAQs</a></li>
              <li><a
                href="#"
                className="text-gray-400 hover:text-primary transition-colors duration-200">Shipping & Returns</a></li>
            </ul>
          </div>
        </div>
